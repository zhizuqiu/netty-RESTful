...
public class HttpStaticFileTools {
     ...
     */
    public static boolean handle(ChannelHandlerContext ctx, FullHttpRequest request, StaticFileHandler staticFileHandler) throws Exception {
        ...
        if (staticFileHandler != null) {
            FullHttpResponse res = staticFileHandler.customResponse(uri, raf, new DefaultFullHttpResponse(HTTP_1_1, OK));
            if (res != null) {
